...
class QGLContext(PyQt5.sip.wrapper):
    ...
    def chooseContext(
        self, shareContext: typing.Optional["QGLContext"] = ...
    ) -> bool: ...
    @staticmethod
...
class QGLWidget(QtWidgets.QWidget):
    ...
    def __init__(
        ...
        shareWidget: typing.Optional["QGLWidget"] = ...,
    ...
    @typing.overload
    def renderText(
        self, x: float, y: float, z: float, str: str, font: QtGui.QFont = ...
    ) -> None: ...
    @staticmethod
    ...
    def renderPixmap(
        self, width: int = ..., height: int = ..., useContext: bool = ...
    ) -> QtGui.QPixmap: ...
    def setContext(
        self,
        context: QGLContext,
        shareContext: typing.Optional[QGLContext] = ...,
    ...
    def isValid(self) -> bool: ...
    def qglClearColor(
        self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    def qglColor(
        self, c: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
