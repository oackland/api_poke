...
class Qt(PyQt5.sip.simplewrapper):
    ...
    class Alignment(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["Qt.Alignment", "Qt.AlignmentFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class WindowFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["Qt.WindowFlags", "Qt.WindowType"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class DropActions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["Qt.DropActions", "Qt.DropAction"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class ItemFlags(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["Qt.ItemFlags", "Qt.ItemFlag"]
        ) -> "Qt.ItemFlags": ...
        def __xor__(
            self, f: typing.Union["Qt.ItemFlags", "Qt.ItemFlag"]
        ) -> "Qt.ItemFlags": ...
    ...
    class MatchFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["Qt.MatchFlags", "Qt.MatchFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QAbstractEventDispatcher(QObject):
    ...
    def removeNativeEventFilter(
        self, filterObj: "QAbstractNativeEventFilter"
    ) -> None: ...
    ...
    def processEvents(
        self,
        flags: typing.Union[
            "QEventLoop.ProcessEventsFlags", "QEventLoop.ProcessEventsFlag"
        ],
    ) -> bool: ...
    @staticmethod
    def instance(
...
class QAbstractItemModel(QObject):
    ...
    def changePersistentIndexList(
        self, from_: typing.Iterable[QModelIndex], to: typing.Iterable[QModelIndex]
    ) -> None: ...
    ...
    def encodeData(
        self, indexes: typing.Iterable[QModelIndex], stream: "QDataStream"
    ) -> None: ...
...
class QIODevice(QObject):
    ...
    class OpenMode(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QIODevice.OpenMode", "QIODevice.OpenModeFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QBuffer(QIODevice):
    ...
    @typing.overload
    def setData(self, adata: PyQt5.sip.array[bytes]) -> None: ...
...
class QByteArray(PyQt5.sipsimplewrapper):
    ...
    def __add__(
        self,
        a1: typing.Union["QByteArray", bytes, bytearray],
        a2: typing.Union["QByteArray", bytes, bytearray],
    ) -> "QByteArray": ...
    @staticmethod
    ...
    @staticmethod
    def fromRawData(a0: PyQt5.sip.array[bytes]) -> "QByteArray": ...
    @typing.overload
    @staticmethod
    def fromBase64(
        base64: typing.Union["QByteArray", bytes, bytearray]
    ...
    @typing.overload
    def __iadd__(
        self, a: typing.Union["QByteArray", bytes, bytearray]
    ) -> "QByteArray": ...
    @typing.overload
    def __iadd__(self, s: str) -> "QByteArray": ...
...
class QByteArrayMatcher(PyQt5.sipsimplewrapper):
    ...
    def setPattern(
        self, pattern: typing.Union[QByteArray, bytes, bytearray]
    ) -> None: ...
...
class QCryptographicHash(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def addData(self, data: PyQt5.sip.array[bytes]) -> None: ...
    @typing.overload
    def addData(self, data: typing.Union[QByteArray, bytes, bytearray]) -> None: ...
    @typing.overload
...
class QDataStream(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __lshift__(self, a0: "QDataStream", a1: "QDate") -> "QDataStream": ...
    @typing.overload
    def __lshift__(self, a0: "QDataStream", a1: "QTime") -> "QDataStream": ...
    @typing.overload
    def __lshift__(self, a0: "QDataStream", a1: "QDateTime") -> "QDataStream": ...
    @typing.overload
    ...
    @typing.overload
    def __lshift__(self, out: "QDataStream", regExp: "QRegExp") -> "QDataStream": ...
    @typing.overload
    def __lshift__(
        self, out: "QDataStream", re: "QRegularExpression"
    ) -> "QDataStream": ...
    @typing.overload
    ...
    @typing.overload
    def __lshift__(self, s: "QDataStream", p: "QVariant.Type") -> "QDataStream": ...
    @typing.overload
    def __lshift__(
        self, out: "QDataStream", version: "QVersionNumber"
    ) -> "QDataStream": ...
    @typing.overload
    ...
    @typing.overload
    def __rshift__(self, in_: "QDataStream", regExp: "QRegExp") -> "QDataStream": ...
    @typing.overload
    def __rshift__(
        self, in_: "QDataStream", re: "QRegularExpression"
    ) -> "QDataStream": ...
    @typing.overload
    ...
    @typing.overload
    def __rshift__(self, s: "QDataStream", p: "QVariant.Type") -> "QDataStream": ...
    @typing.overload
    def __rshift__(
        self, in_: "QDataStream", version: "QVersionNumber"
    ) -> "QDataStream": ...
    ...
    def writeRawData(self, a0: PyQt5.sip.array[bytes]) -> int: ...
    def writeBytes(self, a0: PyQt5.sip.array[bytes]) -> "QDataStream": ...
...
class QDir(PyQt5.sipsimplewrapper):
    ...
    class Filters(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QDir.Filters", "QDir.Filter"]
        ) -> "QDir.Filters": ...
        def __xor__(
            self, f: typing.Union["QDir.Filters", "QDir.Filter"]
        ) -> "QDir.Filters": ...
    ...
    class SortFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QDir.SortFlags", "QDir.SortFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def count(self) -> int: ...
    def setSorting(
        self, sort: typing.Union["QDir.SortFlags", "QDir.SortFlag"]
    ) -> None: ...
    def sorting(self) -> "QDir.SortFlags": ...
    def setFilter(
        self, filter: typing.Union["QDir.Filters", "QDir.Filter"]
    ) -> None: ...
...
class QDirIterator(PyQt5.sipsimplewrapper):
    ...
    class IteratorFlags(PyQt5.sipsimplewrapper):
        ...
        def __init__(
            self,
            f: typing.Union["QDirIterator.IteratorFlags", "QDirIterator.IteratorFlag"],
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    @typing.overload
    def __init__(
        self, dir: QDir, flags: "QDirIterator.IteratorFlags" = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, path: str, flags: "QDirIterator.IteratorFlags" = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QEasingCurve(PyQt5.sipsimplewrapper):
    ...
    def addTCBSegment(
        self, nextPoint: typing.Union["QPointF", "QPoint"], t: float, c: float, b: float
    ) -> None: ...
    def addCubicBezierSegment(
        self,
        c1: typing.Union["QPointF", "QPoint"],
        c2: typing.Union["QPointF", "QPoint"],
        endPoint: typing.Union["QPointF", "QPoint"],
    ) -> None: ...
...
class QFile(QFileDevice):
    ...
    def setPermissions(
        self,
        permissionSpec: typing.Union[QFileDevice.Permissions, QFileDevice.Permission],
    ) -> bool: ...
    @typing.overload
    @staticmethod
    def setPermissions(
    ...
    def open(
        self,
        fd: int,
        ioFlags: typing.Union[QIODevice.OpenMode, QIODevice.OpenModeFlag],
        handleFlags: typing.Union[
            QFileDevice.FileHandleFlags, QFileDevice.FileHandleFlag
        ] = ...,
    ) -> bool: ...
    @typing.overload
    ...
    @staticmethod
    def decodeName(
        localFileName: typing.Union[QByteArray, bytes, bytearray]
    ) -> str: ...
    @typing.overload
    @staticmethod
...
class QLibrary(QObject):
    ...
    @typing.overload
    def __init__(
        self, fileName: str, parent: typing.Optional[QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
...
class QLocale(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def toDateTime(
        self, string: str, format: "QLocale.FormatType" = ...
    ) -> QDateTime: ...
    @typing.overload
...
class QMimeData(QObject):
    def __init__(self) -> None: ...
    def retrieveData(
        self, mimetype: str, preferredType: "QVariant.Type"
    ) -> typing.Any: ...
    ...
    def setData(
        self, mimetype: str, data: typing.Union[QByteArray, bytes, bytearray]
    ) -> None: ...
...
class QMimeDatabase(PyQt5.sipsimplewrapper):
    ...
    def mimeTypeForFileNameAndData(
        self, fileName: str, device: QIODevice
    ) -> "QMimeType": ...
    @typing.overload
    def mimeTypeForFileNameAndData(
        self, fileName: str, data: typing.Union[QByteArray, bytes, bytearray]
    ) -> "QMimeType": ...
    def mimeTypeForUrl(self, url: "QUrl") -> "QMimeType": ...
    @typing.overload
    def mimeTypeForData(
        self, data: typing.Union[QByteArray, bytes, bytearray]
    ) -> "QMimeType": ...
    @typing.overload
    ...
    @typing.overload
    def mimeTypeForFile(
        self, fileName: str, mode: "QMimeDatabase.MatchMode" = ...
    ) -> "QMimeType": ...
    @typing.overload
    def mimeTypeForFile(
...
class QVariantAnimation(QAbstractAnimation):
    ...
    def setKeyValues(
        self, values: typing.Iterable[typing.Tuple[float, typing.Any]]
    ) -> None: ...
...
class QPropertyAnimation(QVariantAnimation):
    ...
    def __init__(
        self,
        target: QObject,
        propertyName: typing.Union[QByteArray, bytes, bytearray],
    ...
    def event(self, event: QEvent) -> bool: ...
    def setPropertyName(
        self, propertyName: typing.Union[QByteArray, bytes, bytearray]
    ) -> None: ...
    def propertyName(self) -> QByteArray: ...
...
class QPluginLoader(QObject):
    ...
    def loadHints(self) -> QLibrary.LoadHints: ...
    def setLoadHints(
        self, loadHints: typing.Union[QLibrary.LoadHints, QLibrary.LoadHint]
    ) -> None: ...
    def errorString(self) -> str: ...
    def fileName(self) -> str: ...
    def setFileName(self, fileName: str) -> None: ...
...
class QPoint(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __mul__(self, p: "QPoint", c: int) -> "QPoint": ...
    @typing.overload
    def __mul__(self, c: int, p: "QPoint") -> "QPoint": ...
    @typing.overload
    def __mul__(self, p: "QPoint", c: float) -> "QPoint": ...
    @typing.overload
    def __mul__(self, c: float, p: "QPoint") -> "QPoint": ...
...
class QPointF(PyQt5.sipsimplewrapper):
    ...
    def __ne__(self, other: object): ...
    def __add__(
        self, p1: typing.Union["QPointF", QPoint], p2: typing.Union["QPointF", QPoint]
    ) -> "QPointF": ...
    def __sub__(
        self, p1: typing.Union["QPointF", QPoint], p2: typing.Union["QPointF", QPoint]
    ) -> "QPointF": ...
    @typing.overload
    def __mul__(self, p: typing.Union["QPointF", QPoint], c: float) -> "QPointF": ...
    @typing.overload
    def __mul__(self, c: float, p: typing.Union["QPointF", QPoint]) -> "QPointF": ...
    def __truediv__(
        self, p: typing.Union["QPointF", QPoint], c: float
    ) -> "QPointF": ...
...
class QRegExp(PyQt5.sipsimplewrapper):
    ...
    def lastIndexIn(
        self, str: str, offset: int = ..., caretMode: "QRegExp.CaretMode" = ...
    ) -> int: ...
    def indexIn(
        self, str: str, offset: int = ..., caretMode: "QRegExp.CaretMode" = ...
    ) -> int: ...
...
class QSettings(QObject):
    ...
    @staticmethod
    def setPath(
        format: "QSettings.Format", scope: "QSettings.Scope", path: str
    ) -> None: ...
    def fileName(self) -> str: ...
    ...
    def value(
        self, key: str, defaultValue: typing.Any = ..., type: type = ...
    ) -> typing.Any: ...
...
class QStandardPaths(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def findExecutable(
        executableName: str, paths: typing.Iterable[str] = ...
    ) -> str: ...
    @staticmethod
...
class QTextBoundaryFinder(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, type: "QTextBoundaryFinder.BoundaryType", string: str
    ) -> None: ...
...
class QTextCodec(PyQt5.sip.wrapper):
    ...
    def convertFromUnicode(
        self, in_: PyQt5.sip.array[str], state: "QTextCodec.ConverterState"
    ) -> QByteArray: ...
    def convertToUnicode(
        self, in_: PyQt5.sip.array[bytes], state: "QTextCodec.ConverterState"
    ) -> str: ...
    ...
    def toUnicode(
        self,
        in_: PyQt5.sip.array[bytes],
        state: typing.Optional["QTextCodec.ConverterState"] = ...,
    ) -> str: ...
    ...
    @staticmethod
    def codecForUtfText(
        ba: typing.Union[QByteArray, bytes, bytearray]
    ) -> "QTextCodec": ...
    @typing.overload
    @staticmethod
    def codecForUtfText(
    ...
    @staticmethod
    def codecForName(
        name: typing.Union[QByteArray, bytes, bytearray]
    ) -> "QTextCodec": ...
    @typing.overload
    @staticmethod
...
class QTextDecoder(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def toUnicode(self, chars: PyQt5.sip.array[bytes]) -> str: ...
    @typing.overload
...
class QTextStream(PyQt5.sipsimplewrapper):
    ...
    class NumberFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QTextStream.NumberFlags", "QTextStream.NumberFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    @typing.overload
    def __lshift__(
        self, array: typing.Union[QByteArray, bytes, bytearray]
    ) -> "QTextStream": ...
    @typing.overload
    ...
    @typing.overload
    def __lshift__(
        self, s: "QTextStream", m: "QTextStreamManipulator"
    ) -> "QTextStream": ...
    ...
    def setNumberFlags(
        self, flags: typing.Union["QTextStream.NumberFlags", "QTextStream.NumberFlag"]
    ) -> None: ...
...
class QThreadPool(QObject):
    ...
    @typing.overload
    def start(
        self, functionToRun: typing.Callable[[], None], priority: int = ...
    ) -> None: ...
    @staticmethod
...
class QTranslator(QObject):
    ...
    def loadFromData(
        self, data: PyQt5.sip.array[bytes], directory: str = ...
    ) -> bool: ...
    @typing.overload
    def load(
        self,
...
class QUrl(PyQt5.sipsimplewrapper):
    ...
    class UserInputResolutionOptions(PyQt5.sipsimplewrapper):
        ...
        def __init__(
            self,
            f: typing.Union[
                "QUrl.UserInputResolutionOptions", "QUrl.UserInputResolutionOption"
            ],
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
    ...
    @staticmethod
    def fromStringList(
        uris: typing.Iterable[str], mode: "QUrl.ParsingMode" = ...
    ) -> typing.List["QUrl"]: ...
    @staticmethod
    def toStringList(
        uris: typing.Iterable["QUrl"], options: "QUrl.FormattingOptions" = ...
    ) -> typing.List[str]: ...
    def query(
        self,
        options: typing.Union[
    ...
    @staticmethod
    def fromEncoded(
        u: typing.Union[QByteArray, bytes, bytearray], mode: "QUrl.ParsingMode" = ...
    ) -> "QUrl": ...
...
class QUuid(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def createUuidV5(
        ns: "QUuid", baseData: typing.Union[QByteArray, bytes, bytearray]
    ) -> "QUuid": ...
    @typing.overload
    @staticmethod
...
class QXmlStreamReader(PyQt5.sipsimplewrapper):
    ...
    def addExtraNamespaceDeclarations(
        self,
        extraNamespaceDeclaractions: typing.Iterable[QXmlStreamNamespaceDeclaration],
    ) -> None: ...
...
def qFormatLogMessage(
    type: QtMsgType, context: QMessageLogContext, buf: str
) -> str: ...
...
@typing.overload
def qChecksum(s: PyQt5.sip.array[bytes]) -> int: ...
@typing.overload
def qChecksum(s: PyQt5.sip.array[bytes], standard: Qt.ChecksumType) -> int: ...
