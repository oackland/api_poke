...
class QAbstractTextDocumentLayout(QtCore.QObject):
    ...
    class PaintContext(PyQt5.sipsimplewrapper):
        ...
        selections = (
            ...
        )  # type: typing.Iterable['QAbstractTextDocumentLayout.Selection']
...
class QPixmap(QPaintDevice):
    ...
    @typing.overload
    def save(
        self, fileName: str, format: typing.Optional[str] = ..., quality: int = ...
    ) -> bool: ...
    @typing.overload
    def save(
        self,
    ...
    def loadFromData(
        self,
        buf: typing.Union[QtCore.QByteArray, bytes, bytearray],
        format: typing.Optional[str] = ...,
        flags: typing.Union[
            QtCore.Qt.ImageConversionFlags, QtCore.Qt.ImageConversionFlag
        ] = ...,
    ...
    def createMaskFromColor(
        self,
        maskColor: typing.Union["QColor", QtCore.Qt.GlobalColor],
    ...
    def fill(
        self, color: typing.Union["QColor", QtCore.Qt.GlobalColor] = ...
    ) -> None: ...
    @staticmethod
...
class QColor(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, acolor: typing.Union["QColor", QtCore.Qt.GlobalColor]
    ) -> None: ...
...
class QGradient(PyQt5.sipsimplewrapper):
    ...
    def setStops(
        ...
        stops: typing.Iterable[
            typing.Tuple[float, typing.Union[QColor, QtCore.Qt.GlobalColor]]
        ],
    ) -> None: ...
    def setColorAt(
        self, pos: float, color: typing.Union[QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
...
class QLinearGradient(QGradient):
    ...
    @typing.overload
    def setFinalStop(
        self, stop: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    @typing.overload
...
class QRadialGradient(QGradient):
    ...
    @typing.overload
    def setCenter(
        self, center: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    @typing.overload
...
class QConicalGradient(QGradient):
    ...
    @typing.overload
    def __init__(
        self, center: typing.Union[QtCore.QPointF, QtCore.QPoint], startAngle: float
    ) -> None: ...
    @typing.overload
...
class QHoverEvent(QInputEvent):
    ...
    def __init__(
        ...
        type: QtCore.QEvent.Type,
        pos: typing.Union[QtCore.QPointF, QtCore.QPoint],
        oldPos: typing.Union[QtCore.QPointF, QtCore.QPoint],
        modifiers: typing.Union[
            QtCore.Qt.KeyboardModifiers, QtCore.Qt.KeyboardModifier
        ] = ...,
    ) -> None: ...
...
class QInputMethodEvent(QtCore.QEvent):
    ...
    def __init__(
        self,
        preeditText: str,
        attributes: typing.Iterable["QInputMethodEvent.Attribute"],
    ) -> None: ...
    @typing.overload
    ...
    def setCommitString(
        self, commitString: str, from_: int = ..., length: int = ...
    ) -> None: ...
...
class QScrollPrepareEvent(QtCore.QEvent):
    @typing.overload
    def __init__(
        self, startPos: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    @typing.overload
...
class QFontDatabase(PyQt5.sipsimplewrapper):
    ...
    def writingSystems(
        self, family: str
    ) -> typing.List["QFontDatabase.WritingSystem"]: ...
    @staticmethod
...
class QImage(QPaintDevice):
    ...
    @typing.overload
    def __init__(
        self, data: bytes, width: int, height: int, format: "QImage.Format"
    ) -> None: ...
    @typing.overload
    def __init__(
        self, data: PyQt5.sip.voidptr, width: int, height: int, format: "QImage.Format"
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    @typing.overload
    def setPixelColor(
        self, x: int, y: int, c: typing.Union[QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    @typing.overload
    def setPixelColor(
        self, pt: QtCore.QPoint, c: typing.Union[QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def fromData(
        data: PyQt5.sip.array[bytes], format: typing.Optional[str] = ...
    ) -> "QImage": ...
    @typing.overload
    @staticmethod
    def fromData(
    ...
    @typing.overload
    def loadFromData(
        self, data: PyQt5.sip.array[bytes], format: typing.Optional[str] = ...
    ) -> bool: ...
    @typing.overload
    def loadFromData(
        self,
    ...
    def convertToFormat(
        self,
        f: "QImage.Format",
        colorTable: typing.Iterable[int],
        flags: typing.Union[
            QtCore.Qt.ImageConversionFlags, QtCore.Qt.ImageConversionFlag
        ] = ...,
    ) -> "QImage": ...
...
class QImageReader(PyQt5.sipsimplewrapper):
    ...
    def imageFormatsForMimeType(
        mimeType: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> typing.List[QtCore.QByteArray]: ...
    def gamma(self) -> float: ...
...
class QKeySequence(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, ks: typing.Union["QKeySequence", "QKeySequence.StandardKey", str, int]
    ) -> None: ...
    @typing.overload
    def __init__(
        self, key: str, format: "QKeySequence.SequenceFormat" = ...
    ) -> None: ...
    @typing.overload
    def __init__(
    ...
    @staticmethod
    def listToString(
        list: typing.Iterable[
            typing.Union["QKeySequence", "QKeySequence.StandardKey", str, int]
        ],
        format: "QKeySequence.SequenceFormat" = ...,
    ) -> str: ...
    @staticmethod
    def listFromString(
        str: str, format: "QKeySequence.SequenceFormat" = ...
    ) -> typing.List["QKeySequence"]: ...
    @staticmethod
    ...
    def isDetached(self) -> bool: ...
    def __ge__(
        self, other: typing.Union["QKeySequence", "QKeySequence.StandardKey", str, int]
    ) -> bool: ...
    def __le__(
        self, other: typing.Union["QKeySequence", "QKeySequence.StandardKey", str, int]
    ) -> bool: ...
    ...
    def matches(
        self, seq: typing.Union["QKeySequence", "QKeySequence.StandardKey", str, int]
...
class QMatrix4x4(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __mul__(
        self, matrix: "QMatrix4x4", point: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> QtCore.QPointF: ...
    @typing.overload
...
class QOpenGLDebugLogger(QtCore.QObject):
    ...
    def disableMessages(
        ...
        types: typing.Union[QOpenGLDebugMessage.Types, QOpenGLDebugMessage.Type] = ...,
        severities: typing.Union[
            QOpenGLDebugMessage.Severities, QOpenGLDebugMessage.Severity
        ] = ...,
    ) -> None: ...
    @typing.overload
...
class QOpenGLShaderProgram(QtCore.QObject):
    ...
    def addCacheableShaderFromSourceCode(
        self,
        type: typing.Union[QOpenGLShader.ShaderType, QOpenGLShader.ShaderTypeBit],
        source: typing.Union[QtCore.QByteArray, bytes, bytearray],
    ) -> bool: ...
    @typing.overload
    def addCacheableShaderFromSourceCode(
        self,
    ...
    def setDefaultInnerTessellationLevels(
        self, levels: typing.Iterable[float]
    ) -> None: ...
    ...
    @typing.overload
    def setUniformValue(
        self, location: int, color: typing.Union[QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    @typing.overload
    def setUniformValue(self, location: int, point: QtCore.QPoint) -> None: ...
    @typing.overload
    def setUniformValue(
        self, location: int, point: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setUniformValue(
        self, name: str, color: typing.Union[QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    @typing.overload
    def setUniformValue(self, name: str, point: QtCore.QPoint) -> None: ...
    @typing.overload
    def setUniformValue(
        self, name: str, point: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setAttributeArray(
        self, name: str, values: PYQT_SHADER_ATTRIBUTE_ARRAY
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setAttributeValue(
        self, location: int, value: typing.Union[QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setAttributeValue(
        self, name: str, value: typing.Union[QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    @typing.overload
    ...
    def bindAttributeLocation(
        self, name: typing.Union[QtCore.QByteArray, bytes, bytearray], location: int
    ) -> None: ...
    @typing.overload
...
class QWindow(QtCore.QObject, QSurface):
    ...
    def startSystemResize(
        self, edges: typing.Union[QtCore.Qt.Edges, QtCore.Qt.Edge]
    ) -> bool: ...
    def setWindowStates(
        self, states: typing.Union[QtCore.Qt.WindowStates, QtCore.Qt.WindowState]
    ) -> None: ...
    ...
    def isAncestorOf(
        self, child: "QWindow", mode: "QWindow.AncestorMode" = ...
    ) -> bool: ...
    ...
    def setFlags(
        self, flags: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType]
    ) -> None: ...
    def requestedFormat(self) -> "QSurfaceFormat": ...
    def format(self) -> "QSurfaceFormat": ...
    def setFormat(self, format: "QSurfaceFormat") -> None: ...
...
class QOpenGLWindow(QPaintDeviceWindow):
    ...
    def __init__(
        ...
        parent: typing.Optional[QWindow] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QPainter(PyQt5.sipsimplewrapper):
    ...
    def drawPixmapFragments(
        self,
        fragments: PyQt5.sip.array["QPainter.PixmapFragment"],
        pixmap: QPixmap,
    ...
    @typing.overload
    def fillRect(
        self, a0: QtCore.QRectF, color: typing.Union[QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    @typing.overload
    def fillRect(
        self, a0: QtCore.QRect, color: typing.Union[QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    @typing.overload
    def fillRect(
        self,
        ...
        w: int,
        h: int,
        b: typing.Union[QColor, QtCore.Qt.GlobalColor],
    ) -> None: ...
    @typing.overload
    def fillRect(
    ...
    @typing.overload
    def boundingRect(
        self, rect: QtCore.QRectF, flags: int, text: str
    ) -> QtCore.QRectF: ...
    @typing.overload
    def boundingRect(
        self, rect: QtCore.QRect, flags: int, text: str
    ) -> QtCore.QRect: ...
    @typing.overload
    def boundingRect(
    ...
    @typing.overload
    def drawText(
        self, p: typing.Union[QtCore.QPointF, QtCore.QPoint], s: str
    ) -> None: ...
    @typing.overload
    def drawText(
    ...
    @typing.overload
    def drawText(
        self, rectangle: QtCore.QRect, flags: int, text: str
    ) -> QtCore.QRect: ...
    @typing.overload
    def drawText(
        self, rectangle: QtCore.QRectF, text: str, option: "QTextOption" = ...
    ...
    def drawConvexPolygon(
        self, points: PyQt5.sip.array[typing.Union[QtCore.QPointF, QtCore.QPoint]]
    ) -> None: ...
    @typing.overload
    def drawConvexPolygon(
    ...
    def drawPolygon(
        self,
        points: PyQt5.sip.array[typing.Union[QtCore.QPointF, QtCore.QPoint]],
    ...
    @typing.overload
    def drawPolygon(
        self, points: PyQt5.sip.array[QtCore.QPoint], fillRule: QtCore.Qt.FillRule = ...
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawLines(
        self, pointPairs: PyQt5.sip.array[typing.Union[QtCore.QPointF, QtCore.QPoint]]
    ) -> None: ...
    @typing.overload
    def drawLines(
    ...
    def strokePath(
        self,
        path: "QPainterPath",
        pen: typing.Union["QPen", QColor, QtCore.Qt.GlobalColor],
    ) -> None: ...
    ...
    @typing.overload
    def setBrushOrigin(
        self, a0: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setPen(
        self, pen: typing.Union["QPen", QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    @typing.overload
...
class QPaintEngine(PyQt5.sipsimplewrapper):
    ...
    def drawPolygon(
        self,
        points: PyQt5.sip.array[QtCore.QPoint],
        mode: "QPaintEngine.PolygonDrawMode",
    ) -> None: ...
    @typing.overload
    def drawPoints(
...
class QPainterPath(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, startPoint: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def addText(
        self, point: typing.Union[QtCore.QPointF, QtCore.QPoint], f: QFont, text: str
    ) -> None: ...
    @typing.overload
    ...
    def quadTo(
        self,
        ctrlPt: typing.Union[QtCore.QPointF, QtCore.QPoint],
        endPt: typing.Union[QtCore.QPointF, QtCore.QPoint],
    ) -> None: ...
    @typing.overload
    def quadTo(
    ...
    def cubicTo(
        self,
        ctrlPt1: typing.Union[QtCore.QPointF, QtCore.QPoint],
        ctrlPt2: typing.Union[QtCore.QPointF, QtCore.QPoint],
        endPt: typing.Union[QtCore.QPointF, QtCore.QPoint],
    ) -> None: ...
    @typing.overload
    def cubicTo(
...
class QPalette(PyQt5.sipsimplewrapper):
    ...
    def __init__(
        self,
        button: typing.Union[QColor, QtCore.Qt.GlobalColor],
        background: typing.Union[QColor, QtCore.Qt.GlobalColor],
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def setColor(
        ...
        acolor: typing.Union[QColor, QtCore.Qt.GlobalColor],
    ) -> None: ...
    @typing.overload
    def setColor(
        self,
...
class QPicture(QPaintDevice):
    ...
    @typing.overload
    def save(
        self, dev: QtCore.QIODevice, format: typing.Optional[str] = ...
    ) -> bool: ...
    @typing.overload
...
class QPolygonF(PyQt5.sipsimplewrapper):
    ...
    def __contains__(
        self, value: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> int: ...
    @typing.overload
    def __delitem__(self, i: int) -> None: ...
    @typing.overload
...
class QQuaternion(PyQt5.sipsimplewrapper):
    ...
    def __ne__(self, other: object): ...
    def __truediv__(
        self, quaternion: "QQuaternion", divisor: float
    ) -> "QQuaternion": ...
...
class QSurfaceFormat(PyQt5.sipsimplewrapper):
    ...
    class FormatOptions(PyQt5.sipsimplewrapper):
        ...
        def __init__(
            self,
            f: typing.Union[
                "QSurfaceFormat.FormatOptions", "QSurfaceFormat.FormatOption"
            ],
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
...
class QSyntaxHighlighter(QtCore.QObject):
    ...
    @typing.overload
    def setFormat(
        self, start: int, count: int, color: typing.Union[QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    @typing.overload
...
class QTextDocumentFragment(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def fromHtml(
        html: str, resourceProvider: QTextDocument
...
class QTextCharFormat(QTextFormat):
    ...
    @typing.overload
    def setFont(
        self, font: QFont, behavior: "QTextCharFormat.FontPropertiesInheritanceBehavior"
    ) -> None: ...
    def isValid(self) -> bool: ...
...
class QTextTableFormat(QTextFrameFormat):
    ...
    def setColumnWidthConstraints(
        self, constraints: typing.Iterable[QTextLength]
    ) -> None: ...
