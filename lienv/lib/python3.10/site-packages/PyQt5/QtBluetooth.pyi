...
class QBluetoothDeviceDiscoveryAgent(QtCore.QObject):
    ...
    class InquiryType(int):
        GeneralUnlimitedInquiry = (
            ...
        )  # type: QBluetoothDeviceDiscoveryAgent.InquiryType
...
class QBluetoothDeviceInfo(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(
        self, uuid: "QBluetoothUuid", name: str, classOfDevice: int
    ) -> None: ...
    @typing.overload
...
class QLowEnergyAdvertisingData(PyQt5.sip.wrapper):
    ...
    def setManufacturerData(
        self, id: int, data: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> None: ...
    @staticmethod
...
class QLowEnergyAdvertisingParameters(PyQt5.sip.wrapper):
    ...
    def whiteList(
        self,
    ) -> typing.List["QLowEnergyAdvertisingParameters.AddressInfo"]: ...
    def setWhiteList(
        self,
...
class QLowEnergyServiceData(PyQt5.sip.wrapper):
    ...
    def setIncludedServices(
        self, services: typing.Iterable[QLowEnergyService]
    ) -> None: ...
