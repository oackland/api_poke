...
class QGeoCodingManager(QtCore.QObject):
    ...
    def reverseGeocode(
        self,
        coordinate: QtPositioning.QGeoCoordinate,
        bounds: QtPositioning.QGeoShape = ...,
    ) -> QGeoCodeReply: ...
    @typing.overload
    def geocode(
...
class QGeoRouteRequest(PyQt5.sipsimplewrapper):
    ...
    def setExtraParameters(
        self, extraParameters: typing.Dict[str, typing.Any]
    ) -> None: ...
    ...
    def setSegmentDetail(
        self, segmentDetail: "QGeoRouteRequest.SegmentDetail"
    ) -> None: ...
...
class QGeoRoutingManager(QtCore.QObject):
    ...
    def setMeasurementSystem(
        self, system: QtCore.QLocale.MeasurementSystem
    ) -> None: ...
    def locale(self) -> QtCore.QLocale: ...
    def setLocale(self, locale: QtCore.QLocale) -> None: ...
...
class QPlace(PyQt5.sipsimplewrapper):
    ...
    def contactDetails(
        self, contactType: str
    ) -> typing.List["QPlaceContactDetail"]: ...
    ...
    def content(
        self, type: "QPlaceContent.Type"
    ) -> typing.Dict[int, "QPlaceContent"]: ...
